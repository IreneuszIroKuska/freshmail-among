...
},{}],"../src/class/InitStructure.js":[function(require,module,exports) {
"use strict";
...
var InitStructure = function InitStructure() {
  ...
  _classCallCheck(this, InitStructure);

  _defineProperty(this, "createElement", function (element) {
    return document.createElement(element);
  });

  _defineProperty(this, "createSelectStructure", function () {
    var select = _this.createElement('select');

    select.setAttribute('name', 'gameCounts');
    var maxGames = _config.config.maxGames; // for increase speed

    for (var i = 0; i < maxGames; i++) {
      var option = _this.createElement('option');

      option.setAttribute('value', "".concat(i + 1));
      option.innerText = "".concat(i + 1);
  ...
  _defineProperty(this, "createSquares", function (className) {
    var elementsCount = _config.config.blocks;

    var div = _this.createElement('div');

    div.classList.add(className); // for increase speed

    for (var i = 0; i < elementsCount; i++) {
      var childDiv = _this.createElement('div');

      childDiv.classList.add('element', "".concat(i + 1));
  ...
  _defineProperty(this, "createGameArea", function (className) {
    var div = _this.createElement('div');

    var squares = _this.createSquares('playArenaContainer');
...
var _default = InitStructure;
exports.default = _default;
},{"../config/config":"../src/config/config.js"}],"../src/index.js":[function(require,module,exports) {
"use strict";

var _InitStructure = _interopRequireDefault(require("./class/InitStructure"));
...
var createPanel = function createPanel(structure) {
  var panelContainer = document.createElement('div');
};

var gameContainer = function gameContainer(structure) {
  if (_typeof(structure) === 'object') {
    var _gameContainer = document.createElement('div');

    var leftSide = structure.createGameArea('leftSide');
    var rightSide = structure.createGameArea('rightSide');
  }
...
window.addEventListener('load', function () {
  ...
  var initStructure = new _InitStructure.default();
  console.info(_typeof(initStructure));
  var leftSide = initStructure.createGameArea('leftSide');
  var rightSide = initStructure.createGameArea('rightSide');
  var select = initStructure.createSelectStructure();
...
},{"./class/InitStructure":"../src/class/InitStructure.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
